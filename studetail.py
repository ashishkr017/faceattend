...
class Student:
    def __init__(self,root):
        ...
        #first 
        img=Image.open("C:\\Users\\ashiu\\3D Objects\\pythonpro\\atten\\image\\stu1.jpg")
...
#second
       # img1=Image.open(r"C:\Users\ashiu\3D Objects\pythonpro\atten\image\first.png")
        img1=Image.open("C:\\Users\\ashiu\\3D Objects\\pythonpro\\atten\\image\\stu1.jpg")
...
#third
        ...
        img2=Image.open("C:\\Users\\ashiu\\3D Objects\\pythonpro\\atten\\image\\stu1.jpg")
        ...
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new rooman",35,"bold"),bg="white",fg="darkgreen")
...
#left image
        img_left=Image.open("C:\\Users\\ashiu\\3D Objects\\pythonpro\\atten\\image\\stu1.jpg")
        img_left=img_left.resize((720,130),Image.Resampling.LANCZOS)#antialias conver high to low
...
#current course
        ...
        dep_combo["values"]=("Select Depertment","computer","IT","electronic")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","BE","B.Tech","MCA")
        ...
        year_combo["values"]=("Select Year","2022-23","2024-25","2025-26","2026-27")
...
#student id
        studentId_label=Label(class_student_frame,text="Enrollment",font=("times new roman",13,"bold"),bg="white")
        ...
        #Phone number
        phno_label=Label(class_student_frame,text="Ph number:",font=("times new roman",13,"bold"),bg="white")
        phno_label.grid(row=3,column=2,padx=10,pady=5,sticky=W)

        phno_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone,width=20,font=("times new roman",13,"bold"))
        ...
        img_right=Image.open("C:\\Users\\ashiu\\3D Objects\\pythonpro\\atten\\image\\stu1.jpg")
        img_right=img_right.resize((720,130),Image.Resampling.LANCZOS)#antialias conver high to low
        ...
        search_label=Label(Search_frame,text="Search by:",font=("times new roman",15,"bold"),bg="gray",fg="white")
        ...
        search_btn=Button(Search_frame,text="Search",width=13,font=("times new roman",11,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3,padx=4)

        showAll_btn=Button(Search_frame,text="Show alll",width=13,font=("times new roman",11,"bold"),bg="blue",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get=="":
                ...
                try:
                        conn=mysql.connector.connect(host="localhost",username="root",password="Ashiucristo@1",database="face_rec")
                        ...
                        messagebox.showinfo("success","you save the info successfully",parent=self.root)
                ...
                # try:
                # conn=mysql.connector.connect(host="localhost",username="root",password="Test@123",database="face_reco")
                # my_cursor=conn.cursor()
                # my_cursor.execute("insert into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) ",(
                #                                                                                        self.var_dep.get(),
                #                                                                                        self.var_course.get(),
    ...
    def fetch_data(self):
        ...
        #get cursor after clicking on detail it put all stuff in input
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get=="":
                ...
                try:
                        ...
                        Update=messagebox.askyesno("Update","do u want to update detial",parent=self.root)
                        if Update>0:
...
# generating data set for photo sample
    ...
    def generate_dataset(self):
         ...
         if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get=="":
                ...
                try:
                        ...
                        self.reset_data()
                        conn.close()
                        #===load predefine data on face frontals form open[cv]
                        face_classifier=cv2.CascadeClassifier("haarcascade_frontalface_default.xml")

                        def face_cropped(img):
                                gray=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
                                faces=face_classifier.detectMultiScale(gray,1.3,5)
                                # scalling factor =1.3 # minium neighor=5
